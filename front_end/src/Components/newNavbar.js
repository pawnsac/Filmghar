...
function NewNavbar({searchText, setSearchText}, props) {
  ...
  <div class="container-fluid">
    ...
    <form class="d-flex moveCenter">
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item2">
        {!loggedIn ? (
        <Link to="/SignUp" className="btn back-color BTN">Signup</Link>
        ) : (
            <Link to="/profile" className="btn back-color BTN">Profile</Link>
        )}
